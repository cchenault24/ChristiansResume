...
export const useGetData = (): ResumeData => ({
    jobExperience: {
        amazon: {
            ...
            icon: '/src/assets/amazon-logo.png',
            logo: '/src/assets/amazon-square.png',
            description: [
        ...
        leidos: {
            ...
            icon: '/src/assets/leidos-logo.png',
            logo: '/src/assets/leidos-square.png',
            description: [
